...
const initialApplications: Application[] = [
  {
    ...
    program_id: 'prg_frontend',
    program_name: 'Frontend Web Engineering',
    motivation: 'I have been self-teaching HTML and CSS for 6 months. I am eager to transition from UI design to full development, and the mentor structure in Skilix aligns perfectly with my learning goals.',
    status: 'pending',
  ...
  },
  {
    ...
    program_id: 'prg_ai',
    program_name: 'AI & Large Language Model Engineering',
    motivation: 'Currently working as a Data Analyst. I want to scale my analytical models using large language agents and vector retrieval databases.',
    status: 'pending',
  ...
  },
  {
    ...
    program_id: 'prg_frontend',
    program_name: 'Frontend Web Engineering',
    motivation: 'Excited to level up to TypeScript and enterprise React framework layout standards.',
    status: 'approved',
