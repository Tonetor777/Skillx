  ...
  return (
    <main className="min-h-screen skx-grid-bg flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <section className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h1 className="mt-6 text-center text-4xl skx-amharic-title">አዲስ ይለፍ ቃል ይምረጡ</h1>
        <p className="mt-2 text-center font-display text-lg font-bold text-[#141414]">Choose a new password</p>
      </section>
